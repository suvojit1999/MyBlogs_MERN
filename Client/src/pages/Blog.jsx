...
const Blog = () => {
    ...
    const GetPostData = async (params) => {
        ...
        const response = await fetch(`https://myblogs-mern-eg1e.onrender.com/blog/${params.id}`);
    ...
    const DeletePost = async () =>{
        try {
            const response = await fetch(`https://myblogs-mern-eg1e.onrender.com/deletepost/${params.id}`, {
              method: 'DELETE',
              credentials: 'include',
            });
